...
public class CAddress implements Externalizable {
    ...
    /**
     * Remove all private informations inside of the object. You can call the method multiple times without error even
     * if the address is already secure.
     */
    ...
    public boolean equals(Object in) {
        if (address == null || in == null || !(in instanceof CAddress))
            return false;
