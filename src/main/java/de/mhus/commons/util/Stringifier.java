...
/**
 * Convert a object into string using pojo mechanism. The conversion is done if the method toString is used for the
 * first time.
 *
 * @author mikehummel
 */
public class Stringifier {
    ...
    private String doStringify(Object in, int level) {
        ...
        try {
            ...
            PojoModel model = new PojoParser().parse(in, "_", null)
