...
/**
 * Write CSV (Comma Separated Value) files. This format is used my Microsoft Word and Excel. Fields are separated by
 ...
 *         Cr, Lf, Tab etc.) before writing.<br>
...
public class CSVWriter {
     ...
     * @param trim
     *            true if writer should trim leading/trailing whitespace (e.g. blank, cr, Lf, tab) before writing the
     *            field.
     */
    ...
    /**
     * Set default value if put() gets a value of null. If the defaultNullValue is also null put() will write a new
     * line. Default is a empty string.
     *
     * @param in
     */
    ...
    /*
     *
     * writer = new CSVWriter(...); writer.setValueWriter(new CSVWriter.DefaultValueWriter() { public void
     * write(CSVWriter writer, String value) { if (MString.isEmpty(value)) return; super(write(writer,value); } }
     *
     */
