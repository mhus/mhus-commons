 ...
 * line is not followed by a comma. Null fields are represented by two commas in a row.
 *
 ...
 *     whitespace (blanks, Cr, Lf, Tab etc.) before writing.<br>
 *     2.1 2005-07-17 reorganization, new bat files.<br>
 *     2.2 2005-08-28 - add CSVAlign and CSVPack to the suite. 2.3 2015-06-12 fix enclosing of
 *     fields
 */
public class CSVWriter {
    ...
    /**
     * line separator to use. We use Windows style for all platforms since csv is a Windows format
     * file.
     */
     ...
     * @param trim true if writer should trim leading/trailing whitespace (e.g. blank, cr, Lf, tab)
    ...
    /**
     * Set default value if put() gets a value of null. If the defaultNullValue is also null put()
     * will write a new line. Default is a empty string.
     *
     * @param in
     */
    ...
    public void print(Object... values) {
        ...
        for (int i = 0; i < values.length; i++) v[i] = String.valueOf(values[i]);
        put(v);
    }
    ...
    /**
     * Write one csv field to the file, followed by a separator unless it is the last field on the
     * line. Lead and trailing blanks will be removed.
     *
     * @param values
     */
