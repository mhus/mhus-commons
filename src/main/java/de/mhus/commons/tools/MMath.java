...
public class MMath {
    ...
    /**
     * Pack the number in a base 36 numerical system. This means the characters 0-9 A-Z are used.
     * This is the maximum packed system if you want to use case insensitive strings.
     *
    ...
    /**
     * Pack the number in a base 36 numerical system. This means the characters 0-9 A-Z are used.
     * This is the maximum packed system if you want to use case insensitive strings. This function
     * creates ids specially for logger traces.
     *
     * @param value The value to convert
